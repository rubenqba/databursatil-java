...
public class IncomeStatementDetailDeserializer extends JsonDeserializer<IncomeStatementDetail> {

    @Override
    public IncomeStatementDetail deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        JsonNode node = p.getCodec().readTree(p);

        return new IncomeStatementDetail(
