...
import com.github.rubenqba.databursatil.util.BalanceSheetStatementDetailDeserializer;

import java.math.BigDecimal;
import java.util.ArrayList;
import java.util.List;

@JsonDeserialize(using = BalanceSheetStatementDetailDeserializer.class)
public record BalanceSheetStatementDetail(
        // Activos (Assets)
