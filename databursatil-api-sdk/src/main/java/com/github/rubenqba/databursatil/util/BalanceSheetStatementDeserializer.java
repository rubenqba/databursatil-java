...
public class BalanceSheetStatementDeserializer extends JsonDeserializer<BalanceSheetStatement> {

    @Override
    public BalanceSheetStatement deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
