...
public class CashFlowStatementDeserializer extends JsonDeserializer<CashFlowStatement> {

    @Override
    public CashFlowStatement deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
